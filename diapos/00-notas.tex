...
\begin{document}
  ...
  está compuesto por:
  \begin{itemize}
    \item diapositivas para ser usadas en cada clase, y
    \item notas de clases como apoyo para los profesores.
  \end{itemize}
  ...
  y apoyándose de la pizarra y el computador
  ...
  Además,
  sirven como recordatorio para puntos importantes
