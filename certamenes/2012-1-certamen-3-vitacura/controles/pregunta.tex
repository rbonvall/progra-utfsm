...
\lstinputlisting[linerange=CONTROLES-FIN\ CONTROLES]{controles/programa.py}
...
\lstinputlisting[linerange=ALUMNOS-FIN\ ALUMNOS]{controles/programa.py}
...
\begin{enumerate}[leftmargin=0pt,label=\emph{\alph*})]
  ...
  \item
    ...
    \lstinputlisting[linerange=CASO\ 1-FIN\ CASO\ 1]{controles/programa.py}
  ...
  \item
    ...
    \lstinputlisting[linerange=CASO\ 2-FIN\ CASO\ 2]{controles/programa.py}

  \item
    Escriba la función \li!alumno_con_mas_estrellitas(controles)!
    que retorne el nombre del alumno con más estrellitas:
    \lstinputlisting[linerange=CASO\ 3-FIN\ CASO\ 3]{controles/programa.py}
